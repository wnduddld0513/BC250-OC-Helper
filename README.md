...
```bash
curl -sSL [https://raw.githubusercontent.com/wnduddld0513/BC250-OC-Helper/main/install.sh](https://raw.githubusercontent.com/wnduddld0513/BC250-OC-Helper/main/install.sh) | bash
